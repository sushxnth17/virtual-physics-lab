...
def experiments():
    ...
    experiment_list = ['lcr', 'diffraction', 'fermi', 'planck', 'photodiode', 'na_optical_fibre', 'blackbox', 'energygap', 'dielectric']  # Add more experiment names as they are developed
